...
- Cloud API running at `https://euronews-001-site1.stempurl.com`
...
| -------------- | ------- | -------------- |
| `NEXT_PUBLIC_API_URL` | `https://euronews-001-site1.stempurl.com` | Production, Preview, Development |
...
3. Enter **Value**: `https://euronews-001-site1.stempurl.com`
...
- `https://euronews-001-site1.stempurl.com/api/Articles`
- `https://euronews-001-site1.stempurl.com/api/Categories`
- `https://euronews-001-site1.stempurl.com/api/BreakingNews`
...
- Check that `NEXT_PUBLIC_API_URL` is exactly: `https://euronews-001-site1.stempurl.com`
...
- Verify image URLs are accessible: `https://euronews-001-site1.stempurl.com/uploads/images/...`
...
- [ ] `NEXT_PUBLIC_API_URL` is set to `https://euronews-001-site1.stempurl.com`
...
4. Test API directly: `curl https://euronews-001-site1.stempurl.com/api/Articles`
