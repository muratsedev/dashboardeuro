...
import { createVideo } from '@/app/dashboard/videos/lib/api';
import { CreateVideoDto } from '@/app/dashboard/videos/types/Video';
  ...
  return (
    <div dir="rtl" className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">إضافة فيديو جديد</h1>
        <button
          onClick={() => router.back()}
