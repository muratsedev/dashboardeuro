...
import { createOpinion, getAuthors, getTags } from "../lib/api";
...
export default function AddOpinionPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const [authorsData, tagsData] = await Promise.all([getAuthors(), getTags()]);
  ...
  return (
    <div className="container mx-auto p-6" dir="rtl">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-semibold text-gray-800">إضافة مقال جديد</h1>
      </div>
